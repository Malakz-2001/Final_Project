...
<head>
  ...
  <title>Rewards - <?php include('../includes/title.php');?></title>
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="#" class="bread-current">Rewards</a>
        </div>
            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left"> Teacher Rewards (in 1 month , 5 points for each session) 
                  </div>
...
include('../includes/dbcon.php');
   ...
   if(empty($_GET['look'])){
   $query=mysqli_query($con,"select * from rooms")or die(mysqli_error($con));
...
// Construct the SQL query to retrieve data for the specific year and month
$get_the_cat = "SELECT * FROM `reservation` 
                WHERE `room_id` = '$id' 
                AND DATE_FORMAT(`date_reserved`, '%Y-%m') = '$currentYearMonth'";
		$cat_res=mysqli_query($con,$get_the_cat);
		$cat_data=mysqli_fetch_array($cat_res);
		$count_reward=mysqli_num_rows($cat_res);
