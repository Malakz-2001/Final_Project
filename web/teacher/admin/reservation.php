...
include('../includes/dbcon.php');
   ...
   if(empty($_GET['look'])){
   $query=mysqli_query($con,"select * from reservation  where reservation.res_id ='$res_id' and reservation.r_status='Approved'")or die(mysqli_error($con));
	   ...
	   $query=mysqli_query($con,"select * from reservation  where rid ='$r_id'")or die(mysqli_error($con));
